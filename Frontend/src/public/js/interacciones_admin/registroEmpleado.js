...
function enviarDatosRegistro(evento) {
    ...
    const datoCombo= document.getElementById('comboRoles');
    const rol=datoCombo.value;
...
function redireccionar() {
    window.location.href = "http://localhost:5500/empleados";
}